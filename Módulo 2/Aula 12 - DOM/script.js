...
ActionsPolicyFormElement: class extends
AutoCheckElement: class Ht
AutocompleteElement: class sn
BatchDeferredContentElement: class extends
ClipboardCopyElement: class on
CollapsibleSidebarWidgetElement: class extends
CommandPalette: class extends
CommandPaletteHelpElement: class extends
CommandPaletteInputElement: class extends
CommandPaletteItemElement: class extends
CommandPaletteItemGroupElement: class extends
CommandPaletteItemStackElement: class extends
CommandPaletteModeElement: class extends
CommandPaletteProviderElement: class extends
CommandPaletteScopeElement: class extends
CommandPaletteTipElement: class extends
CommandPaletteTokenElement: class extends
DetailsDialogElement: class J
DetailsMenuElement: class Ti
FileAttachmentElement: class we
FilterInputElement: class Ot
FuzzyListElement: class ht
GEmojiElement: class Bi
Ge: (_,h)=> {…}
GitCloneHelpElement: class extends
ImageCropElement: class ne
IncludeFragmentElement: class Ze
LocalTimeElement: class Ds
MarkdownBoldButtonElement: class Ji
MarkdownCodeButtonElement: class ts
MarkdownHeaderButtonElement: class Qi
MarkdownImageButtonElement: class is
MarkdownItalicButtonElement: class Zi
MarkdownLinkButtonElement: class ns
MarkdownMentionButtonElement: class as
MarkdownOrderedListButtonElement: class rs
MarkdownQuoteButtonElement: class es
MarkdownRefButtonElement: class cs
MarkdownStrikethroughButtonElement: class ls
MarkdownTaskListButtonElement: class os
MarkdownToolbarElement: class Ut
MarkdownUnorderedListButtonElement: class ss
MarkedTextElement: class Hn
NotificationFocusFiltersElement: class extends
NotificationFocusIndicatorElement: class extends
NotificationFocusListElement: class extends
NotificationFocusListItemElement: class extends
NotificationFocusSidebarElement: class extends
NotificationIndicatorElement: class extends
NotificationsListSubscriptionFormElement: class extends
NotificationsTeamSubscriptionFormElement: class extends
PasswordStrengthElement: class zn
PollIncludeFragmentElement: class To
PreciseTimeAgoElement: class Co
RelativeTimeElement: class Le
RemoteInputElement: class Yt
RemotePaginationElement: class extends
SidebarMemexInputElement: class extends
SlashCommandExpanderElement: class Po
length: 0
name: "SlashCommandExpanderElement"
prototype: HTMLElement {constructor: ƒ, connectedCallback: ƒ, disconnectedCallback: ƒ, setValue: ƒ, …}
[[FunctionLocation]]: slash-command-expander-element.ts:268
[[Prototype]]: ƒ HTMLElement()
[[Scopes]]: Scopes[3]
SudoAuthElement: class extends
SudoPasswordElement: class extends
System: {exports: {…}, register: ƒ, import: ƒ}
TabContainerElement: class an
TaskListsElement: class ie
TextExpanderElement: class Ss
TextSuggesterElement: class extends
TimeAgoElement: class _s
TimeUntilElement: class Ps
TypingEffectElement: class yc
VirtualFilterInputElement: class So
VirtualListElement: class wo
VisiblePasswordElement: class extends
WebauthnGetElement: class extends
alert: ƒ alert()
atob: ƒ atob()
blur: ƒ blur()
btoa: ƒ btoa()
...
gu: ƒ getOwnPropertyDescriptors()
history: History {length: 50, scrollRestoration: 'auto', state: null}
hu: ƒ defineProperties()
indexedDB: IDBFactory {}
innerHeight: 625
innerWidth: 1366
isSecureContext: true
length: 1
litHtmlVersions: ['1.1.2']
localStorage: Storage {ref-selector:rodrigofujioka/devops:branch: '{"refs":["master"],"cacheKey":"v0:1624050254.289789"}', ref-selector:helisana/exercicio1:branch: '{"refs":["main","login-interface","login-scripts"],"cacheKey":"v0:1632158309.947805"}', ref-selector:helisana/porto-seguro:branch: '{"refs":["master"],"cacheKey":"v0:1634686622.9778"}', ref-selector:helisana/bsi-web-email:branch: '{"refs":["master"],"cacheKey":"v0:1572373310.0"}', jump_to:page_views: '{"repository:helisana/fideliz-frontend":{"lastVisi…ini":{"lastVisitedAt":1639277580,"visitCount":1}}', …}
location: Location {ancestorOrigins: DOMStringList, href: 'https://github.com/helisana', origin: 'https://github.com', protocol: 'https:', host: 'github.com', …}
...
performance: Performance {timeOrigin: 1639343568296.8, onresourcetimingbufferfull: null, timing: PerformanceTiming, navigation: PerformanceNavigation, memory: MemoryInfo, …}
...
visualViewport: VisualViewport {offsetLeft: 0, offsetTop: 0, pageLeft: 0, pageTop: 94, width: 1349, …}
vu: ƒ hasOwnProperty()
